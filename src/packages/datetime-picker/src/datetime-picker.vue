<template>
  <jz-popup v-model="visible" :closeOnClickModal="closeOnClickModal" position="bottom" class="jz-datetime">
    <jz-picker
      :slots="dateSlots"
      @change="onChange"
      :visible-item-count="visibleItemCount"
      class="jz-datetime-picker"
      ref="picker"
      show-toolbar>
      <span class="jz-datetime-action jz-datetime-cancel"
            @click="visible = false;$emit('cancel')">{{ cancelText }}</span>
      <span class="jz-datetime-action jz-datetime-confirm" @click="confirm">{{ confirmText }}</span>
    </jz-picker>
  </jz-popup>
</template>
