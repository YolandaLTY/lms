...
<template>
  <div class="jz-swipe">
    <div class="jz-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="jz-swipe-indicators" v-show="showIndicators">
      <div class="jz-swipe-indicator"
...
<script>
  import {once} from '@/assets/utils/dom';
